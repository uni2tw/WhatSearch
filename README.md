...
# 0.6.3
1. 未登入不可在網頁播放 MP3，會導向登入頁
2. 播放音樂加上進度條，顯示目前秒數/總秒數，可拖曳跳轉
3. 登入頁支援記住帳號、Enter 送出
4. /page 新增登出功能（漢堡選單下拉）
5. 點麵包屑空白處可直接切換成搜尋輸入模式
6. 修正 csproj 讓 dotnet build 不再套用 RuntimeIdentifier，避免 wwwroot 未複製
